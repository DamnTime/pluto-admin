...
# 创建 app 目录
RUN mkdir -p /home/backend/pluto-admin

# 设置工作目录
WORKDIR /home/backend/pluto-admin
...
COPY package.json /home/backend/pluto-admin/package.json
